...
{
    $serviceAccountFile = "C:\\xampp1\\htdocs\\tlabaty\\tlabaty-3d8ec-firebase-adminsdk-fbsvc-9a7c36bdd4.json";

    if (!file_exists($serviceAccountFile)) {
        die("❌ File not found: $serviceAccountFile");
    }
    ...
    if (!isset($keyData['client_email'])) {
        die("❌ Missing client_email in JSON file");
    }
    ...
    $ch = curl_init('https://fcm.googleapis.com/v1/projects/tlabaty-3d8ec/messages:send');
